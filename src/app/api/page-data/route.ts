...
const startupPlanList: startupPlan[] = [
  {
    ...
    plan_name: 'Basic',
    plan_descp: 'For students who need essential learning support. Perfect for beginners',
    plan_price: '₹2999',
  ...
  },
  {
    ...
    plan_name: 'Premium',
    plan_descp: 'Complete learning package. Great for board exam preparation',
    plan_price: '₹4999',
...
const faqList: faq[] = [
  {
    faq_que: 'What subjects does Apna Ghar cover?',
    faq_ans:
      'Apna Ghar provides comprehensive study materials for all major subjects from Class 1 to 12, including Mathematics, Science, English, Hindi, Social Studies, and Computer Science.',
  },
  {
    faq_que: 'How long can I access the content?',
    faq_ans:
      'Once enrolled, you get lifetime access to all study materials, videos, and practice tests for your selected class. You can learn at your own pace anytime, anywhere.',
  },
  {
    faq_que: 'How is the content structured at Apna Ghar?',
    faq_ans:
      'Our content is organized by class and subject, with topic-wise videos, downloadable notes, PDFs, and practice tests to help students learn effectively and track their progress.',
  },
  {
    faq_que: 'Do you offer support for doubt clarification?',
    faq_ans:
      'Yes, we provide comprehensive support through our discussion forums where students can ask questions and get help from teachers and fellow students.',
  },
  {
    faq_que: 'Are practice tests available?',
    faq_ans:
      'Yes, we offer extensive practice tests and quizzes for each topic to help students assess their understanding and prepare for exams effectively.',
  },
  {
    faq_que: 'Can I download the study materials?',
    faq_ans:
      'Yes, all PDF notes and study materials can be downloaded for offline access, allowing you to study even without an internet connection.',
  },
]
...
const achievementsList: achievements[] = [
  {
    ...
    sub_title: 'Education Awards',
    title:
      'Celebrated for cutting-edge learning methods and seamless educational experiences.',
    year: '2024',
  ...
  },
  {
    ...
    sub_title: 'Teaching Excellence',
    title: 'Recognized for creative excellence and innovative teaching solutions',
    year: '2023',
    url: 'https://www.framer.com/@wrap-pixel/',
  },
  {
    ...
    sub_title: 'Best Platform Awards',
    title:
      'Honored with Best Educational Platform for quality, usability, and innovation.',
    year: '2022',
    url: 'https://www.framer.com/@wrap-pixel/',
  },
]
