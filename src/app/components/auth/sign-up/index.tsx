                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className='mb-5 text-left'>
                    <select
                      ...
                      className='w-full rounded-full border border-stroke dark:border-white/20 px-5 py-3 outline-hidden transition focus:border-dark_black/50 dark:focus:border-white/50 dark:bg-black/50'
                    >
