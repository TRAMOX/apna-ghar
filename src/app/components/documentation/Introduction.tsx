  ...
  return (
    <>
      <div id='version' className='md:scroll-m-[180px] scroll-m-28'>
        ...
        <div className='mt-5'>
          <p className='text-base font-medium text-midnight_text dark:text-grey'>
            Apna Ghar Educational Platform is built with Tailwindcss and Nextjs.
          </p>
          <p className='text-base font-medium text-midnight_text dark:text-grey'>
            This platform is ready to use and you can totally customize as per
            your requirements for educational purposes.
          </p>
          <p className='text-base font-medium text-midnight_text dark:text-grey'>
